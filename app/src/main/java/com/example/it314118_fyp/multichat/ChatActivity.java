...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatGroup_id=getIntent().getStringExtra("chatGroup_id");
        String userName=getIntent().getStringExtra("chatGroup_Name");
        ...
        mRootRef.child("ChatGroup").child(mChatGroup_id).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void loadMessages() {
        mRootRef.child("ChatGroupMessage").child(mChatGroup_id).addChildEventListener(new ChildEventListener(){
    ...
    private void sendMessage() {
        ...
        if(!TextUtils.isEmpty(message)){
            DatabaseReference user_message_push=mRootRef.child("ChatGroupMessage")
                    .child(mChatGroup_id).push();
            ...
            messageUserMap.put("ChatGroupMessage/"+mChatGroup_id+"/"+push_id,messageMap);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==GALLERY_PICK&&resultCode==RESULT_OK){
            ...
            DatabaseReference user_message_push=mRootRef.child("ChatGroupMessage").child(mChatGroup_id).push();
